...
export const name = 'company-pack'
...
export function apply(ctx: Context): void {
  ...
  ctx.logger.info(
    `${COMPANY_PACK_PACKAGE_NAME}: ${COMPANY_PACK_DISPLAY_NAME} active (example child loaded; no secrets)`,
  )
}
...
export type {
  CompanyPackChild,
  CompanyPackCommunityRecommendation,
  CompanyPackInstallPlan,
  CompanyPackInstallPlanEntry,
} from './manifest.ts'
export {
...
export type {
  CompanyPackCascadeDeps,
  CompanyPackCascadeResult,
  CompanyPackCommunityInstallTarget,
  CompanyPackConfirmedInstall,
} from './install.ts'
